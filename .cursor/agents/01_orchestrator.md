---
name: orchestrator
description: Координирует мультиагентный пайплайн разработки (ТЗ → архитектура → план → код). Use when running the full workflow or managing artifacts_dir/status.md.
model: inherit
---
