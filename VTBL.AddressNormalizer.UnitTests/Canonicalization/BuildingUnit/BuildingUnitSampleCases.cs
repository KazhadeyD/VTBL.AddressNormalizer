...
namespace VTBL.AddressNormalizer.UnitTests.Canonicalization.BuildingUnit
{
    internal static class BuildingUnitSampleCases
    {
        public static IEnumerable<object[]> NormalizeCases => new List<object[]>
        {
            ...
            new object[] { "Э 4", "эт:4" },
            new object[] { "Эт 2 ПОМ 1", "эт:2|пом:1" },
            ...
            new object[] { "ЭТ./ПОМЕЩ. 0/II КОМ./ОФИС 1/24", "эт:0|пом:2|ком:1|оф:24" },
            ...
            new object[] { "II, комн.9; 12", "ком:9|code:12|code:2" },
            ...
            new object[] { "КО 10", "ком:10" },
            new object[] { "ко. 7", "ком:7" },
            new object[] { "ПОМЕЩ. I, ОФИС 307", "пом:1|оф:307" },
            ...
            new object[] { "эт 2 помещ 3/ком 4/оф 23", "эт:2|пом:3|ком:4|оф:23" },
            new object[] { "проезд 1", "проезд:1" },
            new object[] { "1-й проезд", "проезд:1" },
            new object[] { "пр-д 1", "проезд:1" },
            new object[] { "1-й пр-д", "проезд:1" },
