...
namespace VTBL.AddressNormalizer.UnitTests.BuildingAddress
{
    ...
    public class BuildingLocationExtractorSplitTests
    {
        ...
        [InlineData(
            "129301, г. Москва, пр-кт Мира, д. 186, к. 1, эт. 4, пом. 11, ком. 1",
            "г. Москва, пр-кт Мира, д. 186, к. 1",
            "эт. 4, пом. 11, ком. 1")]
        [InlineData("г Москва, ул Сухонская, д 186, к. 1", "г Москва, ул Сухонская, д 186, к. 1", "")]
        [InlineData("г Москва, ул Сухонская, д 186, к 1", "г Москва, ул Сухонская, д 186, к 1", "")]
        [InlineData("г Москва, ул Сухонская, д 1, лит А, кв 5", "г Москва, ул Сухонская, д 1", "лит А, кв 5")]
        [InlineData("г Москва, ул Сухонская, д 11, блок 2, кв 5", "г Москва, ул Сухонская, д 11", "блок 2, кв 5")]
        [InlineData("г Москва, ул Сухонская, д 1, лит А, к. 2", "г Москва, ул Сухонская, д 1", "лит А, к. 2")]
        [InlineData("г Москва, ул Сухонская, д 186, к. 1, кв 5", "г Москва, ул Сухонская, д 186, к. 1", "кв 5")]
        [InlineData("г Москва, ул Сухонская, д 11, эт. 4, пом. 11", "г Москва, ул Сухонская, д 11", "эт. 4, пом. 11")]
